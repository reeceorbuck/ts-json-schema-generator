...
import { createFormatter, FormatterAugmentor } from "../factory/formatter.ts";
import { createParser, ParserAugmentor } from "../factory/parser.ts";
import { createProgram } from "../factory/program.ts";
import { Config, DEFAULT_CONFIG } from "../src/Config.ts";
import { Definition } from "../src/Schema/Definition.ts";
import { SchemaGenerator } from "../src/SchemaGenerator.ts";
import { SubTypeFormatter } from "../src/SubTypeFormatter.ts";
import { EnumType } from "../src/Type/EnumType.ts";
import { FunctionType } from "../src/Type/FunctionType.ts";
import { StringType } from "../src/Type/StringType.ts";
  ...
  it(
    ...
    assertSchema(
      ...
      (formatter, circularReferenceTypeFormatter) =>
        formatter.addTypeFormatter(
          new ExampleDefinitionOverrideFormatter(
